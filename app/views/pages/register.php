<x-layout>
    ...
    <main class="main min-h-screen px-6 py-12 flex flex-col justify-center items-center">
        <h1 class="title text-[2rem] mb-[57px]">Create new account</h1>

        <form method="POST" class="form w-[330px]" id="input-form" autocomplete="off">
            <div class="form__field">
                <label for="name" class="form__label text-gray-400 pb-[.188rem]">Name</label>
                <input type="text" name="name" id="name" class="form__input  w-full bg-gray-900 px-4 py-3.5 rounded focus:outline-none focus:ring-1 focus:ring-inset focus:ring-blue-500" autofocus>
            ...
            <div class="form__field">
                ...
                <input type="text" name="username" id="username" class="form__input  w-full bg-gray-900 px-4 py-3.5 rounded focus:outline-none focus:ring-1 focus:ring-inset focus:ring-blue-500">
                <div class="form__error h-5 text-sm text-red-500 mt-1 mb-[15px]"></div>
            </div>
    ...
    <x-slot name="js">
        ...
        <script type="module" src="{{ @asset('assets/js/_register.js') }}"></script>
    </x-slot>
</x-layout>